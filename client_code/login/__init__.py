...
class login(loginTemplate):
  ...
  def primary_color_1_click(self, **event_args):
    ...
    user = anvil.server.call('login_user', login_input, password)
    ...
    elif user is not None and user['user_password'] != password:
